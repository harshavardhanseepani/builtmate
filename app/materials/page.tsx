...
const MOCK_MATERIALS = [
  ...
  { id: '9', name: 'Teak Wood Planks', category: 'Wood', price: '₹3,500 / sqft', supplier: 'Kerala Timbers', location: 'Trivandrum', stock: 'In Stock', image: 'https://images.unsplash.com/photo-1550508122-d7ff4d4e2874?auto=format&fit=crop&q=80&w=800', contact: { phone: '+91 98765 43218', email: 'sales@keralatimbers.com', address: 'Chalai Market, Trivandrum', hours: 'Mon-Sat: 8 AM - 6 PM' } },
