...
const MOCK_MATERIALS = [
  { id: '1', name: 'UltraTech Cement (50kg)', category: 'Cement', price: '₹380 / bag', supplier: 'Sri Ram Steels', location: 'Andheri East', stock: 'In Stock', image: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&q=80&w=800', contact: { phone: '+91 98765 43210', email: 'sales@sriramsteels.com', address: 'Plot 42, Andheri MIDC, Mumbai', hours: 'Mon-Sat: 8 AM - 7 PM' } },
  { id: '2', name: 'Tata Tiscon 550SD TMT', category: 'Steel', price: '₹65,000 / ton', supplier: 'Bharat Traders', location: 'Koramangala', stock: 'In Stock', image: 'https://images.unsplash.com/photo-1536846171549-36a5b4ec9679?auto=format&fit=crop&q=80&w=800', contact: { phone: '+91 98765 43211', email: 'info@bharattraders.in', address: 'Shop 12, Koramangala 4th Block, Bangalore', hours: 'Mon-Sat: 9 AM - 6 PM' } },
  { id: '3', name: 'Asian Paints Royale', category: 'Paint', price: '₹4,500 / 20L', supplier: 'Metro Colors', location: 'Banjara Hills', stock: 'Low Stock', image: 'https://images.unsplash.com/photo-1562259929-b7e181d8d9b5?auto=format&fit=crop&q=80&w=800', contact: { phone: '+91 98765 43212', email: 'hello@metrocolors.com', address: 'Road No 12, Banjara Hills, Hyderabad', hours: 'Mon-Sun: 10 AM - 8 PM' } },
  ...
  { id: '9', name: 'Teak Wood Planks', category: 'Wood', price: '₹3,500 / sqft', supplier: 'Kerala Timbers', location: 'Trivandrum', stock: 'In Stock', image: 'https://images.unsplash.com/photo-1542171120-d396de23c14f?auto=format&fit=crop&q=80&w=800', contact: { phone: '+91 98765 43218', email: 'sales@keralatimbers.com', address: 'Chalai Market, Trivandrum', hours: 'Mon-Sat: 8 AM - 6 PM' } },
